  ...
  sendData(data){
    axios.post("/prijave/save", data)
        .then(response => {
            ...
            notify("Greska!", "Doslo je do greske, molimo pokusajte ponovo ili nas kontaktirajte", 'danger');
        })
  };
      ...
      <div className="urgently">
        <div className="wrapper">
          ...
          <div className="twoInputs">
            ...
            <div className="input-span">
              <input
                style={{ borderBottom: this.state.errors.brojTelefona ? '1px solid red': '1px solid #797c79' }}
                placeholder="Kontakt telefon"
                type="number"
                className="inp field"
                value={this.state.brojTelefona}
                onChange={e => this.setState({ brojTelefona: e.target.value })}
              ></input>
              <span>
          ...
          <div className="twoInputs">
            <div className="input-span">
              <input
                style={{ borderBottom: this.state.errors.adresa ? '1px solid red': '1px solid #797c79' }}
            ...
            <div className="input-span">
              <input
              style={{ borderBottom: this.state.errors.vrstaZivotinje ? '1px solid red': '1px solid #797c79' }}
                placeholder="Vrsta zivotinje"
                type="text"
                className="inp field"
                value={this.state.vrstaZivotinje}
                onChange={e => this.setState({ vrstaZivotinje: e.target.value })}
              ></input>
              <span>
          ...
          <div className="twoInputs">
            <div className="input-span">
              <input
                style={{ borderBottom: this.state.errors.opisZivotinje ? '1px solid red': '1px solid #797c79' }}
                placeholder="Opis zivotinje (Fizicke karakteristike)"
                type="text"
                className="inp"
                value={this.state.opisZivotinje}
                onChange={e => this.setState({ opisZivotinje: e.target.value })}
              ></input>
              <span>
                <i className="fa fa-github-alt"></i>
              </span>
            ...
            <div className="input-span">
              <input
                style={{ borderBottom: this.state.errors.opisPovrede ? '1px solid red': '1px solid #797c79' }}
          ...
          <div className="twoInputs">
            <div className="input-span">
              <input
                style={{ borderBottom: this.state.errors.slika ? '1px solid red': '1px solid #797c79' }}
                placeholder="Slika"
                type="url"
                className="inp"
            ...
            <div className="input-span">
              <input
                style={{ borderBottom: this.state.errors.stepenUrgentnosti ? '1px solid red': '1px solid #797c79' }}
                ...
                onChange={e => this.setState({ stepenUrgentnosti: e.target.value })}
              ></input>
              <span>
          ...
          <div className="twoInputs">
            <div className="input-span">
              <input
              style={{ borderBottom: this.state.errors.pomocZivotinji ? '1px solid red': '1px solid #797c79' }}
                ...
                onChange={e => this.setState({ pomocZivotinji: e.target.value })}
              ></input>
              <span>
            ...
            <div className="input-span">
              <input
              style={{ borderBottom: this.state.errors.grad ? '1px solid red': '1px solid #797c79' }}
                placeholder="Grad"
                type="text"
                className="inp field"
          ...
          <div className="twoInputs">
            ...
            <textarea style={{width: '100%'}} value={this.state.vasaNapomena} onChange={e => this.setState({ vasaNapomena: e.target.value })} placeholder="Vasa napomena"></textarea>
            </div>
            </div>
          <button className="sendButton" onClick={() => {
               this.sendData(this.state)
          }}>Posalji prijavu</button>
        </div>
      </div>
    );
  }
